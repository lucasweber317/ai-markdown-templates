...
4. **Top 3 objections + responses** — table. Objection (in the customer's own words where possible) → 1–2 sentence response → supporting evidence (roadmap item, customer reference, confirmed decision).
...
7. **Proof points** — customers, pilots, results — but only those confirmed in confirmed decisions or roadmap timing the user provided.
8. **Don't say** — short list of language to avoid: internal codenames, unconfirmed dates, retired terms from the user's glossary (if any), customer names that mustn't reach a prospect.
...
1. Confirm feature, audience, and any competitor names.
...
- No specific dates unless the user confirmed them. Use quarter ranges.
