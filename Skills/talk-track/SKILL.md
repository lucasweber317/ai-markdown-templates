...
5. **Evidence (30 sec)** — 1 customer reference + 1 quantified outcome where available (only if the user confirmed them).
...
1. Confirm the scenario (audience + new prospect vs existing customer) — ask if missing.
2. Pull customer-language hooks and proof from research the user provides; do not invent proof.
3. Draft the talk track (~300–400 spoken words).
